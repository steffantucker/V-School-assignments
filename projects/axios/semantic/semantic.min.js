...
!(function(e, t, n, i) {
  (e.site = e.fn.site = function(o) {
    ...
    return (
      ...
      u
        ? (b === i && a.initialize(), a.invoke(c))
        : (b !== i && a.destroy(), a.initialize()),
      r !== i ? r : this
    );
  }),
    (e.site.settings = {
          ...
          a.each(function() {
            ...
            (P = {
              initialize: function() {
                P.get.settings(),
                  d
                    ? (R === i && P.instantiate(), P.invoke(c))
                    : (R !== i && R.invoke("destroy"),
                      P.verbose("Initializing form validation", E, v),
                      P.bindEvents(),
                      P.set.defaults(),
                      P.instantiate());
              },
              ...
              bindEvents: function() {
                P.verbose("Attaching form events"),
                  E.on("submit" + A, P.validate.form)
                    .on("blur" + A, x.field, P.event.field.blur)
                    .on("click" + A, x.submit, P.submit)
                    .on("click" + A, x.reset, P.reset)
                    .on("click" + A, x.clear, P.clear),
                  v.keyboardShortcuts &&
                    E.on("keydown" + A, x.field, P.event.field.keydown),
                  m.each(function() {
                    var t = e(this),
                      n = t.prop("type"),
              ...
              is: {
                ...
                valid: function(t) {
                  var n = !0;
                  return t
                    ? (P.verbose("Checking if field is valid", t),
                      P.validate.field(b[t], t, !1))
                  ...
                  keydown: function(t) {
                    ...
                    i == 27 &&
                      ...
                      t.ctrlKey ||
                        ...
                        a ||
                        (D ||
                          (n.one("keyup" + A, P.event.field.keyup),
                          P.submit(),
                  ...
                  blur: function(t) {
                    ...
                    i.hasClass(C.error)
                      ? (P.debug("Revalidating field", n, o),
                        o && P.validate.field(o))
                      : "blur" == v.on && o && P.validate.field(o);
                  },
                  change: function(t) {
                    var n = e(this),
                      i = n.closest(g),
                    ...
                    o &&
                      ("change" == v.on ||
                        (i.hasClass(C.error) && v.revalidate)) &&
              ...
              get: {
                    ...
                    d &&
                      ((o =
                        ...
                        (i = s
                          ...
                          .eq(0)).length
                          ? i.text()
                          : s.prop("placeholder") || v.text.unspecifiedField),
                      (c = c.replace("{name}", o))),
                ...
                settings: function() {
                  if (e.isPlainObject(t)) {
                    var n = Object.keys(t);
                    n.length > 0 &&
                    (t[n[0]].identifier !== i && t[n[0]].rules !== i)
                      ? ((v = e.extend(!0, {}, e.fn.form.settings, u)),
                        (b = e.extend({}, e.fn.form.settings.defaults, t)),
                        P.error(v.error.oldSyntax, F),
                        P.verbose(
                      ...
                      : (t.fields &&
                          P.is.shorthandFields(t.fields) &&
                          (t.fields = P.get.fieldsFromShorthand(t.fields)),
                        ...
                        P.verbose("Extending settings", b, v));
                  } else
                    (v = e.fn.form.settings),
                      (b = e.fn.form.settings.defaults),
                      P.verbose("Using default form validation", b, v);
                  (k = v.namespace),
                    (y = v.metadata),
                    (x = v.selector),
                    (C = v.className),
                ...
                values: function(t) {
                  var n = {};
                  return (
                    (e.isArray(t) ? P.get.fields(t) : m).each(function(t, o) {
                      var a = e(o),
              ...
              add: {
                ...
                field: function(t, n) {
                  ...
                  P.is.shorthandRules(n)
                    ...
                    : (i[t] = n),
                    (b = e.extend({}, b, i)),
                    P.debug("Adding rules", i, b);
                },
                fields: function(t) {
                  var n;
                  (n =
                    t && P.is.shorthandFields(t)
                      ? P.get.fieldsFromShorthand(t)
                      : t),
                    (b = e.extend({}, b, n));
                },
                prompt: function(t, n) {
                  ...
                  (n = "string" == typeof n ? [n] : n),
                    ...
                    o.addClass(C.error),
                    v.inline &&
                      (r || (a = v.templates.prompt(n)).appendTo(o),
                      a.html(n[0]),
                      r
                        ? P.verbose(
                        ...
                        : v.transition &&
                          ...
                          ? (P.verbose(
                            ...
                            a.transition(v.transition + " in", v.duration))
                          : (P.verbose(
              ...
              remove: {
                rule: function(t, n) {
                  ...
                  if (n == i)
                    return P.debug("Removed all rules"), void (b[t].rules = []);
                  b[t] != i &&
                    e.isArray(b[t].rules) &&
                    e.each(b[t].rules, function(e, n) {
                      -1 !== o.indexOf(n.type) &&
                        (P.debug("Removed rule", n.type),
                        b[t].rules.splice(e, 1));
                    });
                },
                field: function(t) {
                          ...
                          : c
                            ...
                            : s
                              ...
                              : l
                                ...
                                : (P.verbose("Setting field value", n, o),
                                  o.val(n)));
                    });
                }
              },
                ...
                form: function(e, t) {
                  ...
                  if (((O = []), P.determine.isValid())) {
                    if (
                      ...
                      return v.onSuccess.call(F, e, n);
                  } else if (
                    (P.debug("Form has errors"),
                    P.set.error(),
                    v.inline || P.add.errors(O),
                    E.data("moduleApi") !== i && e.stopImmediatePropagation(),
                    !0 !== t)
                  )
                    return v.onFailure.call(F, O, n);
                },
                field: function(t, n, o) {
                  (o = o === i || o),
                    "string" == typeof t &&
                      (P.verbose("Validating field", t), (n = t), (t = b[t]));
                  ...
                  return (
                    t.identifier ||
                      (P.debug("Using field name as identifier", a),
                      (t.identifier = a)),
                    r.prop("disabled")
                      ? (P.debug("Field is disabled. Skipping", a), (l = !0))
                      : t.optional && P.is.blank(r)
                        ? (P.debug("Field is optional and blank. Skipping", a),
                          (l = !0))
                        : t.depends && P.is.empty(s)
                          ? (P.debug(
                          ...
                          : t.rules !== i &&
                            e.each(t.rules, function(e, n) {
                              P.has.field(a) &&
                                !P.validate.rule(t, n) &&
                                (P.debug("Field is invalid", a, n.type),
                                c.push(P.get.prompt(n, t)),
                                (l = !1));
                            }),
                    l
                      ? (o && (P.remove.prompt(a, c), v.onValid.call(r)), !0)
                      : (o &&
                          ((O = O.concat(c)),
                          P.add.prompt(a, c),
                          v.onInvalid.call(r, c)),
                        !1)
                  );
                },
                rule: function(t, n) {
            ...
            (f = {
              ...
              open: function(t) {
                var n =
                  ...
                  o = n.next(S),
                  a = o.hasClass(g.animating);
                o.hasClass(g.active) || a
                  ? f.debug("Accordion already open, skipping", o)
        ...
        return (
          r.each(function() {
            ...
            (m = {
                ...
                click: function(t) {
                  ...
                  n.is(v.input)
                    ...
                    : n.is(v.link)
                      ...
                      : (m.toggle(), S.focus(), t.preventDefault());
                },
                keydown: function(e) {
                  var t = e.which,
                    n = 13,
              ...
              check: function() {
                m.should.allowCheck() &&
                  (m.debug("Checking checkbox", S),
                  m.set.checked(),
                  m.should.ignoreCallbacks() ||
                    (g.onChecked.call(k), g.onChange.call(k)));
              },
              uncheck: function() {
                m.should.allowUncheck() &&
                  ...
                  m.set.unchecked(),
                  m.should.ignoreCallbacks() ||
                    (g.onUnchecked.call(k), g.onChange.call(k)));
              },
              indeterminate: function() {
                m.should.allowIndeterminate()
                  ...
                  : (m.debug("Making checkbox indeterminate"),
                    m.set.indeterminate(),
                    m.should.ignoreCallbacks() ||
                      (g.onIndeterminate.call(k), g.onChange.call(k)));
              },
              determinate: function() {
                m.should.allowDeterminate()
                  ...
                  : (m.debug("Making checkbox determinate"),
                    m.set.determinate(),
                    m.should.ignoreCallbacks() ||
                      (g.onDeterminate.call(k), g.onChange.call(k)));
              },
              enable: function() {
                m.is.enabled()
              ...
              is: {
                ...
                indeterminate: function() {
                  return (
                    S.prop("indeterminate") !== i && S.prop("indeterminate")
                  );
                },
                checked: function() {
                ...
                allowIndeterminate: function() {
                  return m.is.indeterminate() && !m.should.forceCallbacks()
                    ? (m.debug(
                      ...
                      !1)
                    : !1 !== g.beforeIndeterminate.apply(k) ||
                        (m.debug(
              ...
              set: {
                  ...
                  m.verbose("Setting class to checked"),
                    ...
                    m.is.indeterminate() || !m.is.checked()
                      ? (m.verbose("Setting state to checked", k),
                        S.prop("indeterminate", !1).prop("checked", !0),
                        m.trigger.change())
                      : m.debug(
                  ...
                  m.verbose("Removing checked class"),
                    ...
                    m.is.indeterminate() || !m.is.unchecked()
                      ? (m.debug("Setting state to unchecked"),
                        S.prop("indeterminate", !1).prop("checked", !1),
                        m.trigger.change())
                ...
                tabbable: function() {
                  m.verbose("Adding tabindex to checkbox"),
                    S.attr("tabindex") === i && S.attr("tabindex", 0);
                }
              },
              remove: {
                initialLoad: function() {
              ...
              create: {
                label: function() {
                  S.prevAll(v.label).length > 0
                    ? (S.prev(v.label)
                        .detach()
                        .insertAfter(S),
                      m.debug("Moving existing label", w))
                    : m.has.label() ||
                      ((w = e("<label>").insertAfter(S)),
          ...
          a.each(function() {
            ...
            (m = {
              ...
              bind: {
                events: function() {
                  m.is.page() &&
                    f
                      .get(0)
                      .addEventListener("touchmove", m.event.preventScroll, {
                        passive: !1
                      }),
                    "hover" == g.on
                      ? f
              ...
              unbind: {
                events: function() {
                  m.is.page() &&
                    f
                      .get(0)
                      .removeEventListener("touchmove", m.event.preventScroll, {
                        passive: !1
                      }),
                    S.removeData(x),
                    f.off(y);
              ...
              show: function(t) {
                (t = e.isFunction(t) ? t : function() {}),
                  ...
                  (m.is.dimmed() && !m.is.animating()) || !m.is.enabled()
                    ...
                    : (m.animate.show(t), g.onShow.call(k), g.onChange.call(k));
              },
              hide: function(t) {
                (t = e.isFunction(t) ? t : function() {}),
              ...
              has: {
                dimmer: function() {
                  return g.dimmerName
                    ? S.find(p.dimmer).filter("." + g.dimmerName).length > 0
                    : S.find(p.dimmer).length > 0;
                }
              },
              is: {
                active: function() {
      ...
      (e.fn.dropdown = function(o) {
        ...
        return (
          r.each(function(p) {
            ...
            (S = {
              initialize: function() {
                S.debug("Initializing dropdown", k),
                  S.is.alreadySetup()
                    ? S.setup.reference()
                    : (S.setup.layout(),
                      k.values && S.change.values(k.values),
                      S.refreshData(),
                      S.save.defaults(),
                      S.restore.selected(),
                      S.create.id(),
              ...
              instantiate: function() {
                S.verbose("Storing instance of dropdown", S),
                  (J = S),
                  M.data(I, S);
              },
              destroy: function() {
                S.verbose("Destroying previous dropdown", M),
                  S.remove.tabbable(),
                  M.off(z).removeData(I),
                  Q.off(z),
                  s.off(y),
                  S.disconnect.menuObserver(),
                  S.disconnect.selectObserver();
              },
              observeChanges: function() {
                "MutationObserver" in t &&
                  ((C = new MutationObserver(S.event.select.mutation)),
                  (w = new MutationObserver(S.event.menu.mutation)),
                  S.debug("Setting up mutation observer", C, w),
                  S.observe.select(),
                  S.observe.menu());
              },
              disconnect: {
              ...
              observe: {
                select: function() {
                  S.has.input() &&
                    C.observe(M[0], { childList: !0, subtree: !0 });
                },
                menu: function() {
                  S.has.menu() &&
              ...
              create: {
                id: function() {
                  (x = (Math.random().toString(16) + "000000000").substr(2, 8)),
                    (y = "." + x),
                    S.verbose("Creating unique id for element", x);
                },
                userChoice: function(t) {
                  var n, o, a;
                  return (
                    !!(t = t || S.get.userValues()) &&
                    ((t = e.isArray(t) ? t : [t]),
                    e.each(t, function(t, r) {
                      !1 === S.get.item(r) &&
                        ((a = k.templates.addition(
                          S.add.variables(A.addResult, r)
                        )),
                        (o = e("<div />")
                          .html(a)
                          .attr("data-" + E.value, r)
                          ...
                          .addClass(T.addition)
                          .addClass(T.item)),
                        k.hideAdditions && o.addClass(T.hidden),
                        (n = n === i ? o : n.add(o)),
                        S.verbose("Creating user choices for value", r, o));
                    }),
                    n)
                  );
                },
              ...
              search: function(e) {
                (e = e !== i ? e : S.get.query()),
                  S.verbose("Searching for query", e),
                  S.has.minCharacters(e) ? S.filter(e) : S.hide();
              },
              select: {
                firstUnfiltered: function() {
                  S.verbose("Selecting first non-filtered element"),
                    S.remove.selectedItem(),
                ...
                nextAvailable: function(e) {
                  var t = (e = e.eq(0))
                    ...
                    n = e
                      ...
                      .eq(0);
                  t.length > 0
                    ? (S.verbose("Moving selection to", t),
                      t.addClass(T.selected))
                    : (S.verbose("Moving selection to", n),
              ...
              setup: {
                api: function() {
                  var e = {
                    debug: k.debug,
                    urlData: { value: S.get.value(), query: S.get.query() },
                    on: !1
                  };
                ...
                layout: function() {
                  M.is("select") &&
                    (S.setup.select(), S.setup.returnedObject()),
                    S.has.menu() || S.create.menu(),
                    S.is.search() &&
                      !S.has.search() &&
                      (S.verbose("Adding search input"),
                      (N = e("<input />")
                        .addClass(T.search)
                    ...
                    U.parent(D.dropdown).length > 0
                      ...
                      : (S.debug("Creating entire dropdown from select"),
                        ...
                        U.hasClass(T.multiple) &&
                          !1 === U.prop("multiple") &&
                          (S.error(q.missingMultiple), U.prop("multiple", !0)),
                        U.is("[multiple]") && S.set.multiple(),
                        U.prop("disabled") &&
                          (S.debug("Disabling dropdown"),
                          M.addClass(T.disabled)),
                        U.removeAttr("class")
                          .detach()
                          .prependTo(M)),
                    S.refresh();
                ...
                reference: function() {
                  S.debug(
                    ...
                    (M = M.parent(D.dropdown)),
                    (J = M.data(I)),
                    (K = M.get(0)),
                    S.refresh(),
                    S.setup.returnedObject();
                },
              ...
              refreshData: function() {
                S.verbose("Refreshing cached metadata"),
                  X.removeData(E.text).removeData(E.value);
              },
              clearData: function() {
                S.verbose("Clearing metadata"),
                  X.removeData(E.text).removeData(E.value),
                  M.removeData(E.defaultText)
                    .removeData(E.defaultValue)
                    .removeData(E.placeholderText);
              },
              toggle: function() {
                S.verbose("Toggling menu visibility"),
                  S.is.active() ? S.hide() : S.show();
              },
              show: function(t) {
                if (
                  ((t = e.isFunction(t) ? t : function() {}),
                  !S.can.show() &&
                    S.is.remote() &&
                    (S.debug("No API results retrieved, searching before show"),
                    S.queryRemote(S.get.query(), S.show)),
                  S.can.show() && !S.is.active())
                ) {
                  if (
                    (S.debug("Showing dropdown"),
                    !S.has.message() ||
                      S.has.maxSelections() ||
                  ...
                  !1 !== k.onShow.call(K) &&
                    S.animate.show(function() {
                      S.can.click() && S.bind.intent(),
                        S.has.menuSearch() && S.focusSearch(),
                        S.set.visible(),
                        t.call(K);
                    });
                }
              ...
              hideMenu: function() {
                S.verbose("Hiding menu  instantaneously"),
                  S.remove.active(),
                  S.remove.visible(),
                  Q.transition("hide");
              },
              ...
              bind: {
                events: function() {
                  c && S.bind.touchEvents(),
                    S.bind.keyboardEvents(),
                    S.bind.inputEvents(),
                    S.bind.mouseEvents();
                },
                touchEvents: function() {
                  S.debug(
                    ...
                    S.is.searchSelection() ||
                      (S.is.single() &&
                        M.on("touchstart" + z, S.event.test.toggle)),
                    Q.on("touchstart" + z, D.item, S.event.item.mouseenter);
                },
                keyboardEvents: function() {
                  S.verbose("Binding keyboard events"),
                    M.on("keydown" + z, S.event.keydown),
                    S.has.search() &&
                      M.on(S.get.inputEvent() + z, D.search, S.event.input),
                    S.is.multiple() &&
                      s.on("keydown" + y, S.event.document.keydown);
                },
                inputEvents: function() {
                  S.verbose("Binding input change events"),
                    M.on("change" + z, D.input, S.event.change);
                },
                mouseEvents: function() {
                  S.verbose("Binding mouse events"),
                    S.is.multiple() &&
                      M.on("click" + z, D.label, S.event.label.click).on(
                        "click" + z,
                        D.remove,
                        S.event.remove.click
                      ),
                    S.is.searchSelection()
                      ? (M.on("mousedown" + z, S.event.mousedown)
                          .on("mouseup" + z, S.event.mouseup)
                          .on("mousedown" + z, D.menu, S.event.menu.mousedown)
                          .on("mouseup" + z, D.menu, S.event.menu.mouseup)
                          ...
                          .on("click" + z, D.text, S.event.text.focus),
                        S.is.multiple() && M.on("click" + z, S.event.click))
                      : ("click" == k.on
                          ? M.on("click" + z, D.icon, S.event.icon.click).on(
                              "click" + z,
                              S.event.test.toggle
                            )
                          : "hover" == k.on
                            ? M.on("mouseenter" + z, S.delay.show).on(
                                "mouseleave" + z,
                                S.delay.hide
                              )
                            : M.on(k.on + z, S.toggle),
                        M.on("mousedown" + z, S.event.mousedown)
                          .on("mouseup" + z, S.event.mouseup)
                          .on("focus" + z, S.event.focus),
                        S.has.menuSearch()
                          ? M.on("blur" + z, D.search, S.event.search.blur)
                          : M.on("blur" + z, S.event.blur)),
                    Q.on("mouseenter" + z, D.item, S.event.item.mouseenter)
                      .on("mouseleave" + z, D.item, S.event.item.mouseleave)
                      .on("click" + z, D.item, S.event.item.click);
                },
                intent: function() {
                  S.verbose("Binding hide intent event to document"),
                    c &&
                      s
                        .on("touchstart" + y, S.event.test.touch)
                        .on("touchmove" + y, S.event.test.touch),
                    s.on("click" + y, S.event.test.hide);
                }
              },
              unbind: {
                intent: function() {
                  S.verbose("Removing hide intent event from document"),
                ...
                var t = e !== i ? e : S.get.query(),
                  n = function() {
                    S.is.multiple() && S.filterActive(),
                      (e || (!e && 0 == S.get.activeItem().length)) &&
                        S.select.firstUnfiltered(),
                      S.has.allResultsFiltered()
                        ? k.onNoResults.call(K, t)
                          ? k.allowAdditions
                            ? k.hideAdditions &&
                              (S.verbose(
                            ...
                            : (S.verbose(
                              ...
                              S.add.message(A.noResults))
                          : (S.verbose(
                              "All items filtered, hiding dropdown",
                              t
                            ),
                            S.hideMenu())
                        : (S.remove.empty(), S.remove.message()),
                      k.allowAdditions && S.add.userSuggestion(e),
                      S.is.searchSelection() &&
                        S.can.show() &&
                        S.is.focusedOnSearch() &&
                        S.show();
                  };
                (k.useLabels && S.has.maxSelections()) ||
                  (k.apiSettings
                    ? S.can.useAPI()
                ...
                var i = {
                  ...
                  onSuccess: function(t) {
                    ...
                    e.isArray(i) && i.length > 0
                      ? (S.remove.message(),
                        S.setup.menu({ values: t[R.remoteValues] }))
                      : S.add.message(A.noResults),
                      n();
                  }
                };
                M.api("get request") || S.setup.api(),
                ...
                S.has.query() &&
                  ...
                  X.each(function() {
                    ...
                    if ("both" == k.match || "text" == k.match) {
                      if (
                        -1 !== (t = String(S.get.choiceText(a, !1))).search(r)
                      )
                        return o.push(this), !0;
                      if ("exact" === k.fullTextSearch && S.exactSearch(n, t))
                        return o.push(this), !0;
                      if (!0 === k.fullTextSearch && S.fuzzySearch(n, t))
                        return o.push(this), !0;
                    }
                    if ("both" == k.match || "value" == k.match) {
                      if (
                        -1 !== (i = String(S.get.choiceValue(a, t))).search(r)
                      )
                        return o.push(this), !0;
                      if ("exact" === k.fullTextSearch && S.exactSearch(n, i))
                        return o.push(this), !0;
                      if (!0 === k.fullTextSearch && S.fuzzySearch(n, i))
                        return o.push(this), !0;
                    }
                  })),
              ...
              focusSearch: function(e) {
                S.has.search() &&
                  !S.is.focusedOnSearch() &&
                  (e
                    ? (M.off("focus" + z, D.search),
                      N.focus(),
                      M.on("focus" + z, D.search, S.event.search.focus))
                    : N.focus());
              },
              forceSelection: function() {
                var e = X.not(T.filtered)
                  ...
                  t = X.not(T.filtered)
                    ...
                    .eq(0),
                  n = e.length > 0 ? e : t;
                if (n.length > 0 && !S.is.multiple())
                  return (
                    S.debug("Forcing partial selection to selected item", n),
                    void S.event.item.click.call(n, {}, !0)
                  );
                k.allowAdditions
                  ? (S.set.selected(S.get.query()), S.remove.searchTerm())
                  : S.remove.searchTerm();
              },
              change: {
                values: function(t) {
                  k.allowAdditions || S.clear(),
                    S.debug("Creating dropdown with specified values", t),
                    S.setup.menu({ values: t }),
                    e.each(t, function(e, t) {
                      if (1 == t.selected)
                        return (
                          S.debug("Setting initial selection to", t.value),
                          S.set.selected(t.value),
                          !0
                        );
                    });
                }
              ...
              event: {
                change: function() {
                  Z ||
                    (S.debug("Input changed, updating selection"),
                    S.set.selected());
                },
                focus: function() {
                ...
                click: function(t) {
                  e(t.target).is(M) &&
                    (S.is.focusedOnSearch() ? S.show() : S.focusSearch());
                },
                search: {
                  focus: function() {
                    ($ = !0),
                      S.is.multiple() && S.remove.activeLabel(),
                      k.showOnFocus && S.search();
                  },
                  blur: function(e) {
                    (v = n.activeElement === this),
                      S.is.searchSelection() &&
                        ...
                        (Y ||
                          v ||
                          (k.forceSelection && S.forceSelection(), S.hide())),
                      (b = !1);
                  }
                },
                icon: {
                ...
                input: function(e) {
                  (S.is.multiple() || S.is.searchSelection()) &&
                    S.set.filtered(),
                    clearTimeout(S.timer),
                    (S.timer = setTimeout(S.search, k.delay.search));
                },
                label: {
                  click: function(t) {
                    var n = e(this),
                ...
                remove: {
                  click: function() {
                    ...
                    t.hasClass(T.active)
                      ...
                      : S.remove.activeLabels(t);
                  }
                },
                test: {
                  toggle: function(e) {
                    var t = S.is.multiple() ? S.show : S.toggle;
                    S.is.bubbledLabelClick(e) ||
                      S.is.bubbledIconClick(e) ||
                ...
                menu: {
                  mutation: function(t) {
                    ...
                    r || s
                      ? (S.debug("Updating item selector cache"),
                        S.refreshItems())
                      : (S.debug("Menu modified, updating selector cache"),
                        S.refresh());
                  },
                  mousedown: function() {
                    Y = !0;
                ...
                item: {
                  ...
                  click: function(t, i) {
                    var o = e(this),
                      ...
                      c = r.length > 0,
                      u = r.find(a).length > 0;
                    S.has.menuSearch() && e(n.activeElement).blur(),
                      u ||
                        (c && !k.allowCategorySelection) ||
                        (S.is.searchSelection() &&
                          (k.allowAdditions && S.remove.userAddition(),
                          S.remove.searchTerm(),
                          S.is.focusedOnSearch() ||
                            1 == i ||
                            S.focusSearch(!0)),
                        k.useLabels ||
                          (S.remove.filteredItem(), S.set.scrollPosition(o)),
                        S.determine.selectAction.call(this, s, l));
                  }
                },
                document: {
                  keydown: function(e) {
                    ...
                    if (S.is.inObject(t, P)) {
                      ...
                      t == P.leftArrow
                        ? (!f && !m) || r
                          ? r &&
                            (e.shiftKey
                              ? S.verbose("Adding previous label to selection")
                              : (S.verbose("Selecting previous label"),
                            ...
                            e.preventDefault())
                          : (S.verbose("Selecting previous label"),
                            n.last().addClass(T.active))
                        : t == P.rightArrow
                          ? (f && !r && n.first().addClass(T.active),
                            r &&
                              (e.shiftKey
                                ? S.verbose("Adding next label to selection")
                                : (S.verbose("Selecting next label"),
                                  n.removeClass(T.active)),
                              c
                                ? u
                                  ? d
                                    ...
                                    : S.focusSearch()
                                  : s
                                    ? i.next(D.siblingLabel).addClass(T.active)
                                    : i.addClass(T.active)
                                : i.next(D.siblingLabel).addClass(T.active),
                              e.preventDefault()))
                          : t == P.deleteKey || t == P.backspace
                            ? r
                              ? (S.verbose("Removing active labels"),
                                c && u && !d && S.focusSearch(),
                                i
                                  .last()
                                  .next(D.siblingLabel)
                                  .addClass(T.active),
                                S.remove.activeLabels(i),
                                e.preventDefault())
                              : m &&
                                !r &&
                                t == P.backspace &&
                ...
                keydown: function(e) {
                  ...
                  if (S.is.inObject(t, P)) {
                    var n,
                      ...
                      r =
                        a.length > 0
                          ? a.siblings(":not(." + T.filtered + ")").addBack()
                          : Q.children(":not(." + T.filtered + ")"),
                      s = a.children(D.menu),
                      l = a.closest(D.menu),
                      c =
                        l.hasClass(T.visible) ||
                        l.hasClass(T.animating) ||
                        l.parent(D.menu).length > 0,
                      u = s.length > 0,
                      d = a.length > 0,
                      f = a.not(D.unselectable).length > 0,
                      m =
                        t == P.delimiter && k.allowAdditions && S.is.multiple();
                    if (
                      (k.allowAdditions &&
                        k.hideAdditions &&
                        (t == P.enter || m) &&
                        f &&
                        (S.verbose("Selecting item from keyboard shortcut", a),
                        S.event.item.click.call(a, e),
                        S.is.searchSelection() && S.remove.searchTerm()),
                      S.is.visible())
                    ) {
                      if (
                        ((t == P.enter || m) &&
                          (t == P.enter && d && u && !k.allowCategorySelection
                            ? (S.verbose(
                        ...
                        d &&
                          (t == P.leftArrow &&
                            l[0] !== Q[0] &&
                            (S.verbose("Left key pressed, closing sub-menu"),
                            S.animate.hide(!1, l),
                          ...
                          t == P.rightArrow &&
                            u &&
                            (S.verbose("Right key pressed, opening sub-menu"),
                            S.animate.show(!1, s),
                            a.removeClass(T.selected),
                            s
                              .find(D.item)
                        ...
                        S.verbose("Up key pressed, changing active item"),
                          a.removeClass(T.selected),
                          n.addClass(T.selected),
                          S.set.scrollPosition(n),
                          k.selectOnKeydown &&
                            S.is.single() &&
                            S.set.selectedItem(n),
                          e.preventDefault();
                      }
                      if (t == P.downArrow) {
                        if (
                        ...
                        S.verbose("Down key pressed, changing active item"),
                      ...
                      t == P.pageUp && (S.scrollPage("up"), e.preventDefault()),
                        t == P.pageDown &&
                          (S.scrollPage("down"), e.preventDefault()),
                        t == P.escape &&
                          (S.verbose("Escape key pressed, closing dropdown"),
                          S.hide());
                    } else
                      m && e.preventDefault(),
                        t != P.downArrow ||
                          S.is.visible() ||
                          (S.verbose("Down key pressed, showing dropdown"),
                          S.show(),
                          e.preventDefault());
                  } else
                    S.has.search() ||
                      S.set.selectedLetter(String.fromCharCode(t));
                }
              },
              trigger: {
                change: function() {
              ...
              determine: {
                selectAction: function(t, n) {
                  S.verbose("Determining action", k.action),
                    e.isFunction(S.action[k.action])
                      ? (S.verbose("Triggering preset action", k.action, t, n),
                        S.action[k.action].call(K, t, n, this))
                      : e.isFunction(k.action)
                        ? (S.verbose("Triggering user action", k.action, t, n),
                          k.action.call(K, t, n, this))
                        : S.error(q.action, k.action);
                },
                eventInModule: function(t, i) {
                  ...
                  return (
                    ...
                    a && !r
                      ? (S.verbose("Triggering event", i), i(), !0)
                      : (S.verbose(
              ...
              action: {
                ...
                activate: function(t, n, o) {
                  if (((n = n !== i ? n : t), S.can.activate(e(o)))) {
                    if (
                      (S.set.selected(n, e(o)),
                      S.is.multiple() && !S.is.allFiltered())
                    )
                      return;
                    S.hideAndClear();
                  }
              ...
              get: {
                ...
                values: function() {
                  ...
                  return "" === e
                    ? ""
                    : !S.has.selectInput() && S.is.multiple()
                      ? "string" == typeof e
                        ? e.split(k.delimiter)
                        : ""
                      : e;
                  ...
                  return (
                    t &&
                      ...
                      e.each(t, function(e, t) {
                        ...
                        S.verbose("Restoring value from session data", i, t),
                          i && (n || (n = {}), (n[t] = i));
                      })),
                    n
                  );
                ...
                choiceText: function(t, n) {
                  if (((n = n !== i ? n : k.preserveHTML), t))
                    return (
                      t.find(D.menu).length > 0 &&
                        (S.verbose("Retrieving text of element with sub-menu"),
                ...
                selectValues: function() {
                  ...
                  return (
                    ...
                    k.placeholder &&
                      "auto" !== k.placeholder &&
                      (S.debug("Setting placeholder value to", k.placeholder),
                    ...
                    k.sortSelect
                      ...
                      : S.debug("Retrieved values from select", t),
                    t
                  );
                },
                activeItem: function() {
                      ...
                      X.each(function() {
                        ...
                        if (null !== l && l !== i)
                          if (a)
                            ...
                            return (
                              S.verbose("Found select item by value", l, t),
                              (r = o),
                              !0
                            );
                      }),
              ...
              check: {
                maxSelections: function(e) {
                  return (
                    ...
                    k.maxSelections
                      ? (S.debug("Maximum selection count reached"),
                        k.useLabels &&
                          (X.addClass(T.filtered),
                          S.add.message(A.maxSelections)),
                        !0)
                      : (S.verbose("No longer at maximum selection count"),
                        S.remove.message(),
                        S.remove.filteredItem(),
                        S.is.searchSelection() && S.filterItems(),
                        !1))
                  );
                }
              },
              restore: {
                ...
                defaultText: function() {
                  ...
                  e === S.get.placeholderText
                    ? (S.debug("Restoring default placeholder text", e),
                      S.set.placeholderText(e))
                    : (S.debug("Restoring default text", e), S.set.text(e));
                },
                placeholderText: function() {
                ...
                defaultValue: function() {
                  ...
                  e !== i &&
                    (S.debug("Restoring default value", e),
                    "" !== e
                      ? (S.set.value(e), S.set.selected())
                      : (S.remove.activeItem(), S.remove.selectedItem()));
                },
                labels: function() {
                  k.allowAdditions &&
                    (k.useLabels || (S.error(q.labels), (k.useLabels = !0)),
                    S.debug("Restoring selected values"),
                    S.create.userLabels()),
                  ...
                  S.restore.values(),
                    S.is.multiple()
                      ? (S.debug(
                        ...
                        S.restore.labels())
                      : S.debug("Restoring previously selected values");
                },
                values: function() {
                  S.set.initialLoad(),
                    k.apiSettings && k.saveRemoteData && S.get.remoteValues()
                      ? S.restore.remoteValues()
                      : S.set.selected(),
              ...
              save: {
                defaults: function() {
                  S.save.defaultText(),
                    S.save.placeholderText(),
                    S.save.defaultValue();
                },
                defaultValue: function() {
                  var e = S.get.value();
                  S.verbose("Saving default value as", e),
                    M.data(E.defaultValue, e);
                },
                defaultText: function() {
                  var e = S.get.text();
                  S.verbose("Saving default text as", e),
                    M.data(E.defaultText, e);
                },
                placeholderText: function() {
                  var e;
                  !1 !== k.placeholder &&
                    V.hasClass(T.placeholder) &&
                    ((e = S.get.text()),
                    S.verbose("Saving placeholder text as", e),
                    M.data(E.placeholderText, e));
                },
                remoteData: function(e, n) {
                  t.Storage !== i
                    ? (S.verbose("Saving remote data to session storage", n, e),
                      sessionStorage.setItem(n, e))
                    : S.error(q.noStorage);
                }
              },
              clear: function() {
                S.is.multiple() && k.useLabels
                  ? S.remove.labels()
                  : (S.remove.activeItem(), S.remove.selectedItem()),
                  S.set.placeholderText(),
                  S.clearValue();
                ...
                (i = "up" == e ? d.index(o) - c : d.index(o) + c),
                  ...
                  : i < d.length)
                    ...
                    : "up" == e
                      ? d.first()
                      : d.last()).length > 0 &&
                    (S.debug("Scrolling page", e, n),
                    o.removeClass(T.selected),
                    n.addClass(T.selected),
                    k.selectOnKeydown && S.is.single() && S.set.selectedItem(n),
                    a.scrollTop(u));
              },
              set: {
                filtered: function() {
                  ...
                  e &&
                    o &&
                    (S.verbose("Adjusting input width", a, k.glyphWidth),
                    N.css("width", a)),
                    o || (n && r)
                      ? (S.verbose("Hiding placeholder text"),
                        V.addClass(T.filtered))
                      : (!e || (n && !r)) &&
                        (S.verbose("Showing placeholder text"),
                        V.removeClass(T.filtered));
                },
                empty: function() {
                  M.addClass(T.empty);
                },
                ...
                placeholderText: function(e) {
                  (e = e || S.get.placeholderText()),
                    S.debug("Setting placeholder text", e),
                    S.set.text(e),
                    V.addClass(T.placeholder);
                },
                tabbable: function() {
                  S.is.searchSelection()
                    ? (S.debug("Added tabindex to searchable dropdown"),
                      N.val("").attr("tabindex", 0),
                      Q.attr("tabindex", -1))
                    : (S.debug("Added tabindex to dropdown"),
                      M.attr("tabindex") === i &&
                        (M.attr("tabindex", 0), Q.attr("tabindex", -1)));
                },
                initialLoad: function() {
                  S.verbose("Setting initial load"), (h = !0);
                },
                activeItem: function(e) {
                  k.allowAdditions && e.filter(D.addition).length > 0
                ...
                scrollPosition: function(e, t) {
                  var n, o, a, r, s, l;
                  (n = (e = e || S.get.selectedItem()).closest(D.menu)),
                    (o = e && e.length > 0),
                    (t = t !== i && t),
                    e &&
                      n.length > 0 &&
                      ...
                      (a =
                        (r = n.scrollTop()) - n.offset().top + e.offset().top),
                      t || ((l = r + n.height() < a + 5), (s = a - 5 < r)),
                      S.debug("Scrolling to active item", a),
                      (t || s || l) && n.scrollTop(a),
                ...
                text: function(e) {
                  "select" !== k.action &&
                    ("combo" == k.action
                      ? (S.debug("Changing combo button text", e, B),
                        k.preserveHTML ? B.html(e) : B.text(e))
                      : (e !== S.get.placeholderText() &&
                          V.removeClass(T.placeholder),
                        S.debug("Changing text", e, V),
                        V.removeClass(T.filtered),
                        k.preserveHTML ? V.html(e) : V.text(e)));
                },
                selectedItem: function(e) {
                  var t = S.get.choiceValue(e),
                    n = S.get.choiceText(e, !1),
                    i = S.get.choiceText(e, !0);
                  S.debug("Setting user selection to item", e),
                    S.remove.activeItem(),
                    S.set.partialSearch(n),
                    S.set.activeItem(e),
                    S.set.selected(t, e),
                    S.set.text(i);
                },
                selectedLetter: function(t) {
                  var n,
                    ...
                    o = !1;
                  i.length > 0 &&
                    S.has.firstLetter(i, t) &&
                    ((n = i.nextAll(X).eq(0)),
                    S.has.firstLetter(n, t) && (o = n)),
                    o ||
                      X.each(function() {
                        if (S.has.firstLetter(e(this), t))
                          return (o = e(this)), !1;
                      }),
                    o &&
                      (S.verbose("Scrolling to next value with letter", t),
                      S.set.scrollPosition(o),
                      i.removeClass(T.selected),
                      o.addClass(T.selected),
                      k.selectOnKeydown &&
                        S.is.single() &&
                        S.set.selectedItem(o));
                },
                direction: function(e) {
                  "auto" == k.direction
                    ? (S.remove.upward(),
                      S.can.openDownward(e)
                        ? S.remove.upward(e)
                        : S.set.upward(e),
                      S.is.leftward(e) ||
                        S.can.openRightward(e) ||
                        S.set.leftward(e))
                    : "upward" == k.direction && S.set.upward(e);
                },
                upward: function(e) {
                ...
                value: function(e, t, n) {
                  ...
                  if (a) {
                    ...
                    S.is.single() &&
                      S.has.selectInput() &&
                      S.can.extendSelect() &&
                      (S.debug("Adding user option", e), S.add.optionValue(e)),
                      S.debug("Updating input value", o, r),
                      (Z = !0),
                      U.val(o),
                      !1 === k.fireOnInit && S.is.initialLoad()
                        ? S.debug(
                    ...
                    S.verbose("Storing value in metadata", o, U),
                      o !== r && M.data(E.value, s);
                  !1 === k.fireOnInit && S.is.initialLoad()
                    ? S.verbose("No callback on initial load", k.onChange)
                    : k.onChange.call(K, e, t, n);
                },
                active: function() {
                  M.addClass(T.active);
                },
                ...
                exactly: function(e, t) {
                  S.debug("Setting selected to exact values"),
                    S.clear(),
                    S.set.selected(e, t);
                },
                selected: function(t, n) {
                  var i = S.is.multiple();
                  (n = k.allowAdditions
                    ? n || S.get.itemWithAdditions(t)
                    : n || S.get.item(t)) &&
                    (S.debug("Setting selected menu item to", n),
                    S.is.multiple() && S.remove.searchWidth(),
                    S.is.single()
                      ? (S.remove.activeItem(), S.remove.selectedItem())
                      : k.useLabels && S.remove.selectedItem(),
                    n.each(function() {
                      var t = e(this),
                      ...
                      i
                        ? !s || l
                          ? (k.apiSettings &&
                              k.saveRemoteData &&
                              S.save.remoteData(o, a),
                            k.useLabels
                              ? (S.add.label(a, o, c),
                                S.add.value(a, o, t),
                                S.set.activeItem(t),
                                S.filterActive(),
                                S.select.nextAvailable(n))
                              : (S.add.value(a, o, t),
                                S.set.text(S.add.variables(A.count)),
                                S.set.activeItem(t)))
                          : r ||
                            (S.debug("Selected active value, removing label"),
                            S.remove.selected(a))
                        : (k.apiSettings &&
                            k.saveRemoteData &&
                            S.save.remoteData(o, a),
              ...
              add: {
                label: function(t, n, i) {
                  ...
                  k.ignoreCase && (r = r.toLowerCase()),
                    ...
                    S.has.label(t)
                      ? S.debug("User selection already exists, skipping", r)
                      : (k.label.variation && o.addClass(k.label.variation),
                        !0 === i
                          ? (S.debug("Animating in label", o),
                            o
                              .addClass(T.hidden)
                              .insertBefore(a)
                              .transition(k.label.transition, k.label.duration))
                          : (S.debug("Adding selection label", o),
                            o.insertBefore(a)));
                },
                message: function(t) {
                ...
                optionValue: function(t) {
                  ...
                  U.find('option[value="' + S.escape.string(n) + '"]').length >
                    0 ||
                    (S.disconnect.selectObserver(),
                    S.is.single() &&
                      (S.verbose("Removing previous user addition"),
                  ...
                  (k.useLabels && S.has.maxSelections()) ||
                    ("" === e || o
                      ...
                      : (a
                          ...
                          : ((n = S.create.userChoice(e)).prependTo(Q),
                            S.verbose(
                              "Adding item choice to menu corresponding with user choice addition",
                              n
                            )),
                        (k.hideAdditions && !S.is.allFiltered()) ||
                          n
                            .addClass(T.selected)
                            .siblings()
                ...
                variables: function(e, t) {
                  ...
                  return (
                    ...
                    o &&
                      ((n = S.get.selectionCount()),
                      (e = e.replace("{count}", n))),
                    a &&
                      ((n = S.get.selectionCount()),
                      (e = e.replace("{maxCount}", k.maxSelections))),
                    r &&
                      ((i = t || S.get.query()), (e = e.replace("{term}", i))),
                    e
                  );
                },
                value: function(t, n, i) {
                  var o,
                    a = S.get.values();
                  S.has.value(t)
                    ? S.debug("Value already selected")
                    : "" !== t
                      ? (e.isArray(a)
                          ? ((o = a.concat([t])), (o = S.get.uniqueArray(o)))
                          : (o = [t]),
                        S.has.selectInput()
                          ? S.can.extendSelect() &&
                            (S.debug("Adding value to select", t, o, U),
                            S.add.optionValue(t))
                        ...
                        !1 === k.fireOnInit && S.is.initialLoad()
                          ...
                          : k.onAdd.call(K, t, n, i),
                        S.set.value(o, t, n, i),
                        S.check.maxSelections())
                      : S.debug("Cannot select blank values from multiselect");
                }
              },
              remove: {
                active: function() {
                ...
                optionValue: function(e) {
                  ...
                  n.length > 0 &&
                    ...
                    (C &&
                      (C.disconnect(),
                      S.verbose("Temporarily disconnecting mutation observer")),
                    n.remove(),
                    S.verbose("Removing user addition as an <option>", t),
                ...
                value: function(e, t, n) {
                  ...
                  S.has.selectInput()
                    ? (S.verbose(
                      ...
                      (i = S.remove.arrayValue(e, o)),
                      S.remove.optionValue(e))
                    : (S.verbose("Removing from delimited values", e),
                      (i = (i = S.remove.arrayValue(e, o)).join(k.delimiter))),
                    !1 === k.fireOnInit && S.is.initialLoad()
                      ? S.verbose("No callback on initial load", k.onRemove)
                      : k.onRemove.call(K, e, t, n),
                    S.set.value(i, t, n),
                    S.check.maxSelections();
                },
                ...
                label: function(e, t) {
                  var n = M.find(D.label).filter(
                    "[data-" + E.value + '="' + S.escape.string(e) + '"]'
                  );
                  S.verbose("Removing label", n), n.remove();
                },
                activeLabels: function(e) {
                  (e = e || M.find(D.label).filter("." + T.active)),
                    S.verbose("Removing active label selections", e),
                    S.remove.labels(e);
                },
                labels: function(t) {
                  (t = t || M.find(D.label)),
                    ...
                    t.each(function() {
                      ...
                      !1 !== k.onLabelRemove.call(t, n)
                        ? (S.remove.message(),
                          a
                            ? (S.remove.value(o), S.remove.label(o))
                            : S.remove.selected(o))
                        : S.debug("Label remove callback cancelled removal");
                    });
                },
                tabbable: function() {
                  S.is.searchSelection()
                    ? (S.debug("Searchable dropdown initialized"),
                      N.removeAttr("tabindex"),
                      Q.removeAttr("tabindex"))
                    : (S.debug("Simple selection dropdown initialized"),
              ...
              has: {
                ...
                minCharacters: function(e) {
                  return (
                    !k.minCharacters ||
                    (e = e !== i ? String(e) : String(S.get.query())).length >=
                      k.minCharacters
                  );
                },
                ...
                label: function(e) {
                  ...
                  return (
                    ...
                    n.filter(
                      "[data-" + E.value + '="' + S.escape.string(t) + '"]'
                    ).length > 0
                  );
                },
                maxSelections: function() {
                  return (
                    k.maxSelections && S.get.selectionCount() >= k.maxSelections
                  );
                },
                ...
                value: function(e) {
                  return k.ignoreCase
                    ? S.has.valueIgnoringCase(e)
                    : S.has.valueMatchingCase(e);
                },
              ...
              is: {
                ...
                allFiltered: function() {
                  return (
                    (S.is.multiple() || S.has.search()) &&
                    !(0 == k.hideAdditions && S.has.userSuggestion()) &&
                    !S.has.message() &&
                    S.has.allResultsFiltered()
                  );
                },
              ...
              can: {
                activate: function(e) {
                  return (
                    !!k.useLabels ||
                    (!S.has.maxSelections() ||
                      !(!S.has.maxSelections() || !e.hasClass(T.active)))
                  );
                },
                openDownward: function(e) {
                  ...
                  return (
                    ...
                    (i = {
                      context: {
                        offset:
                          L.get(0) === t ? { top: 0, left: 0 } : L.offset(),
                    ...
                    (n = {
                      ...
                      below:
                        ...
                        i.menu.offset.top - i.context.offset.top + i.menu.height
                    }).below
                      ? (S.verbose("Dropdown can fit in context downward", n),
                        (a = !0))
                      : n.below || n.above
                        ? (S.verbose(
                ...
                openRightward: function(e) {
                  ...
                  return (
                    ...
                    (n =
                      ...
                      (S.verbose("Dropdown cannot fit in context rightward", n),
                      (a = !1)),
                    o.removeClass(T.loading),
                    a
                  );
              ...
              animate: {
                show: function(t, n) {
                  ...
                  (t = e.isFunction(t) ? t : function() {}),
                    S.verbose("Doing menu show animation", a),
                    S.set.direction(n),
                    (o = S.get.transition(n)),
                    S.is.selection() &&
                      S.set.scrollPosition(S.get.selectedItem(), !0),
                    (S.is.hidden(a) || S.is.animating(a)) &&
                      ("none" == o
                        ? (r(), a.transition("show"), t.call(K))
                        : e.fn.transition !== i && M.transition("is supported")
                          ? a.transition({
                              animation: o + " in",
                              debug: k.debug,
                              verbose: k.verbose,
                ...
                hide: function(t, n) {
                  ...
                  (t = e.isFunction(t) ? t : function() {}),
                    (S.is.visible(o) || S.is.animating(o)) &&
                      (S.verbose("Doing menu hide animation", o),
                      "none" == r
                        ? (a(), o.transition("hide"), t.call(K))
                        : e.fn.transition !== i && M.transition("is supported")
                          ? o.transition({
                              animation: r + " out",
                              duration: k.duration,
              ...
              delay: {
                show: function() {
                  S.verbose("Delaying show event to ensure user intent"),
                    clearTimeout(S.timer),
                    (S.timer = setTimeout(S.show, k.delay.show));
                },
                hide: function() {
                  S.verbose("Delaying hide event to ensure user intent"),
                    clearTimeout(S.timer),
                    (S.timer = setTimeout(S.hide, k.delay.hide));
                }
              },
              escape: {
                value: function(t) {
                  ...
                  return o || !a
                    ? t
                    : (S.debug("Encoding quote values for use in select", t),
                      n
                        ? (e.each(t, function(e, t) {
              ...
              m
                ? (J === i && S.initialize(), S.invoke(f))
                : (J !== i && J.invoke("destroy"), S.initialize());
          }),
          a !== i ? a : r
        );
      }),
            ...
            (f = {
              ...
              destroy: function() {
                f.verbose("Destroying previous instance of embed"),
                  f.reset(),
                  S.removeData(w).off(C);
              },
              refresh: function() {
                f.verbose("Refreshing selector cache"),
                  S.find(g.placeholder),
                  S.find(g.icon),
                  (k = S.find(g.embed));
              },
              bind: {
                events: function() {
                  f.has.placeholder() &&
                    ...
                    S.on("click" + C, g.placeholder, f.createAndShow).on(
                      "click" + C,
                      g.icon,
                      f.createAndShow
                    ));
              ...
              createEmbed: function(t) {
                f.refresh(),
                  ...
                  (k = e("<div/>")
                    ...
                    .appendTo(S)),
                  m.onCreate.call(T, t),
                  f.debug("Creating embed object", k);
              },
              ...
              change: function(e, t, n) {
                f.debug("Changing video to ", e, t, n),
                  S.data(b.source, e).data(b.id, t),
                  n ? S.data(b.url, n) : S.removeData(b.url),
              ...
              generate: {
                ...
                parameters: function(t, n) {
                  ...
                  return (
                    (n = n || m.parameters) && (o = e.extend({}, o, n)),
                    (o = m.onEmbed(o)),
              ...
              should: {
                autoplay: function() {
                  return "auto" === m.autoplay
                    ? m.placeholder || S.data(b.placeholder) !== i
                    : m.autoplay;
                }
              },
              is: {
      ...
      (e.fn.modal = function(o) {
        ...
        return (
          r.each(function() {
            ...
            (k = {
              initialize: function() {
                k.verbose("Initializing dimmer", q),
                  k.create.id(),
                  k.create.dimmer(),
                  k.refreshModals(),
                  k.bind.events(),
                  T.observeChanges && k.observeChanges(),
                  k.instantiate();
              },
              instantiate: function() {
              ...
              attachEvents: function(t, n) {
                ...
                (n = e.isFunction(k[n]) ? k[n] : k.toggle),
                  i.length > 0
                    ...
                    : k.error(E.notFound, t);
              },
              bind: {
                events: function() {
                  k.verbose("Attaching events"),
                    D.on("click" + F, A.close, k.event.close)
                      .on("click" + F, A.approve, k.event.approve)
                      .on("click" + F, A.deny, k.event.deny),
                    s.on("resize" + C, k.event.resize);
                }
              },
              get: {
                id: function() {
                ...
                click: function(t) {
                  if (T.closable) {
                    ...
                    !i &&
                      ...
                      k.remove.clickaway(),
                      T.allowMultiple ? k.hide() : k.hideAll());
                  } else
                    k.verbose(
                ...
                (t = e.isFunction(t) ? t : function() {}),
                  k.is.animating() || !k.is.active()
                    ? (k.showDimmer(),
                      ...
                      k.set.type(),
                      k.set.clickaway(),
                      !T.allowMultiple && k.others.active()
              ...
              showDimmer: function() {
                y.dimmer("is animating") || !y.dimmer("is active")
                  ? (k.debug("Showing dimmer"), y.dimmer("show"))
              ...
              add: {
                keyboardShortcuts: function() {
                  k.verbose("Adding keyboard shortcuts"),
                    l.on("keyup" + F, k.event.keyboard);
                }
              },
              save: {
                focus: function() {
                  e(n.activeElement).closest(D).length > 0 ||
                    ...
                    T.inverted
                      ? ((n.variation =
                          n.variation !== i
                            ...
                            : "inverted"),
                        x.addClass(R.inverted))
                      : x.removeClass(R.inverted),
                      T.blurring
                        ? y.addClass(R.blurring)
                        : y.removeClass(R.blurring),
                      q.dimmer("setting", n);
                ...
                screenHeight: function() {
                  k.can.fit()
                    ...
                    : (k.debug(
                      ...
                      c.css("height", k.cache.height + 2 * T.padding));
                },
                active: function() {
                  D.addClass(R.active);
                },
              ...
              g
                ? (I === i && k.initialize(), k.invoke(m))
                : (I !== i && I.invoke("destroy"), k.initialize());
          }),
          a !== i ? a : this
        );
      }),
      ...
      (e.fn.popup = function(o) {
        ...
        return (
          r.each(function() {
            ...
            (x = {
              initialize: function() {
                x.debug("Initializing", E),
                  x.createID(),
                  x.bind.events(),
                  !x.exists() && C.preserve && x.create(),
                  C.observeChanges && x.observeChanges(),
                  x.instantiate();
              },
              instantiate: function() {
              ...
              observeChanges: function() {
                "MutationObserver" in t &&
                  ((v = new MutationObserver(x.event.documentChanged)).observe(
                    n,
              ...
              refresh: function() {
                C.popup
                  ? (r = e(C.popup).eq(0))
                  : C.inline && ((r = q.nextAll(w.popup).eq(0)), (C.popup = r)),
                  C.popup
                    ? (r.addClass(S.loading),
                      (h = x.get.offsetParent()),
                      r.removeClass(S.loading),
                      C.movePopup &&
                        x.has.popup() &&
                        x.get.offsetParent(r)[0] !== h[0] &&
                        (x.debug(
                          "Moving popup to the same offset parent as target"
                        ),
                        r.detach().appendTo(h)))
                    : (h = C.inline
                        ? x.get.offsetParent(q)
                        : x.has.popup()
                          ? x.get.offsetParent(r)
                          : c),
                  h.is("html") &&
                    h[0] !== c[0] &&
                    (x.debug("Setting page as offset parent"), (h = c)),
                  x.get.variation() && x.set.variation();
              },
              reposition: function() {
                x.refresh(), x.set.position();
              },
              destroy: function() {
                x.debug("Destroying previous module"),
                  v && v.disconnect(),
                  r && !C.preserve && x.removePopup(),
                  clearTimeout(x.hideTimer),
              ...
              event: {
                start: function(t) {
                  ...
                  clearTimeout(x.hideTimer),
                    I || (x.showTimer = setTimeout(x.show, n));
                },
                end: function() {
                  var t = e.isPlainObject(C.delay) ? C.delay.hide : C.delay;
                  clearTimeout(x.showTimer),
                    (x.hideTimer = setTimeout(x.hide, t));
                },
                ...
                hideGracefully: function(t) {
                  ...
                  t && !a && o
                    ? (x.debug("Click occurred outside popup hiding popup"),
                      x.hide())
                    : x.debug("Click was inside popup, keeping popup open");
                }
              },
              create: function() {
                var t = x.get.html(),
                  ...
                  i = x.get.content();
                t || i || n
                  ? (x.debug("Creating pop-up html"),
                    t || (t = C.templates.popup({ title: n, content: i })),
                    (r = e("<div/>")
                      .addClass(S.popup)
                      .data(T.activator, E)
                      .html(t)),
                    C.inline
                      ? (x.verbose("Inserting popup element inline", r),
                        r.insertAfter(E))
                      : (x.verbose("Appending popup element to body", r),
                        r.appendTo(F)),
                    x.refresh(),
                    x.set.variation(),
                    C.hoverable && x.bind.popup(),
                    C.onCreate.call(r, M))
                  : 0 !== q.next(w.popup).length
                    ? (x.verbose("Pre-existing popup found"),
                      (C.inline = !0),
                      (C.popup = q.next(w.popup).data(T.activator, E)),
                      x.refresh(),
                      C.hoverable && x.bind.popup())
                    : C.popup
                      ? (e(C.popup).data(T.activator, E),
                        x.verbose("Used popup specified in settings"),
                        x.refresh(),
                        C.hoverable && x.bind.popup())
                      : x.debug("No content specified skipping display", M);
              },
              createID: function() {
              ...
              toggle: function() {
                x.debug("Toggling pop-up"),
                  x.is.hidden()
                    ? (x.debug("Popup is hidden, showing pop-up"),
                      x.unbind.close(),
                      x.show())
                    : (x.debug("Popup is visible, hiding pop-up"), x.hide());
              },
              show: function(e) {
                if (
                  ((e = e || function() {}),
                  x.debug("Showing pop-up", C.transition),
                  x.is.hidden() && (!x.is.active() || !x.is.dropdown()))
                ) {
                  if ((x.exists() || x.create(), !1 === C.onShow.call(r, M)))
                    return void x.debug(
                      "onShow callback returned false, cancelling popup animation"
                    );
                  C.preserve || C.popup || x.refresh(),
                    r &&
                      x.set.position() &&
                      (x.save.conditions(),
                      C.exclusive && x.hideAll(),
                      x.animate.show(e));
                }
              },
              hide: function(e) {
                if (
                  ((e = e || function() {}), x.is.visible() || x.is.animating())
                ) {
                  if (!1 === C.onHide.call(r, M))
                    return void x.debug(
              ...
              exists: function() {
                return (
                  ...
                  (C.inline || C.popup
                    ? x.has.popup()
                    : r.closest(F).length >= 1)
                );
              },
              removePopup: function() {
                x.has.popup() &&
                  !C.popup &&
                  (x.debug("Removing popup", r),
                  r.remove(),
                  (r = i),
                  C.onRemove.call(r, M));
              },
              save: {
                conditions: function() {
                  (x.cache = { title: E.attr("title") }),
                    x.cache.title && E.removeAttr("title"),
                    x.verbose("Saving original attributes", x.cache.title);
                }
              },
              restore: {
                conditions: function() {
              ...
              get: {
                ...
                content: function() {
                  return (
                    E.removeData(T.content),
                    E.data(T.content) || C.content || E.attr("title")
                  );
                },
                variation: function() {
                  return (
                    E.removeData(T.variation),
                    E.data(T.variation) || C.variation
                  );
                },
                popup: function() {
                  return r;
                ...
                calculations: function() {
                  ...
                  return (
                    ...
                    (c.target.margin.top = C.inline
                      ? parseInt(
                          t.getComputedStyle(i).getPropertyValue("margin-top"),
                          10
                        )
                      : 0),
                    (c.target.margin.left = C.inline
                      ? x.is.rtl()
                        ? parseInt(
                            t
                              .getComputedStyle(i)
                ...
                distanceFromBoundary: function(e, t) {
                  var n,
                    ...
                    o = {};
                  return (
                    (n = (t = t || x.get.calculations()).popup),
                    (i = t.boundary),
                    e &&
                      ((o = {
                        top: e.top - i.top,
                      ...
                      x.verbose("Distance from boundaries determined", e, o)),
                    o
                  );
                },
                ...
                nextPosition: function(e) {
                  ...
                  return (
                    z ||
                      (x.verbose("All available positions available"),
                      (z = x.get.positions())),
                    x.debug("Recording last position tried", e),
                    (z[e] = !0),
                    "opposite" === C.prefer &&
                      ((s = (s = [
                        {
                      ...
                      (a = !0 === z[s]),
                      x.debug("Trying opposite strategy", s)),
                    "adjacent" === C.prefer &&
                      o &&
                      ((s = (s = [
                        n,
                      ...
                      (r = !0 === z[s]),
                      x.debug("Trying adjacent strategy", s)),
                    (r || a) &&
                      (x.debug("Using backup position", s),
                      (s = {
                        "top left": "top center",
              ...
              set: {
                position: function(e, t) {
                  if (0 !== q.length && 0 !== r.length) {
                    var n, o, a, s, l, c, u, d;
                    if (
                      ((t = t || x.get.calculations()),
                      (e = e || E.data(T.position) || C.position),
                      (n = E.data(T.offset) || C.offset),
                      (o = C.distanceAway),
                      (a = t.target),
                      (s = t.popup),
                      (l = t.parent),
                      x.should.centerArrow(t) &&
                        (x.verbose(
                          "Adjusting offset to center arrow on small target element"
                        ),
                        ("top left" != e && "bottom left" != e) ||
                          ((n += a.width / 2), (n -= C.arrowPixelsFromEdge)),
                        ("top right" != e && "bottom right" != e) ||
                          ((n -= a.width / 2), (n += C.arrowPixelsFromEdge))),
                      0 === a.width && 0 === a.height && !x.is.svg(a.element))
                    )
                      return (
                        x.debug("Popup target is hidden, no action taken"), !1
                      );
                    switch (
                      (C.inline &&
                        (x.debug("Adding margin to calculation", a.margin),
                      ...
                      x.is.rtl() &&
                        ...
                        x.debug("RTL: Popup position updated", e)),
                      j == C.maxSearchDepth &&
                        "string" == typeof C.lastResort &&
                        (e = C.lastResort),
                      e)
                    ) {
                      case "top left":
                    ...
                    if (
                      (c === i && x.error(k.invalidPosition, e),
                      x.debug("Calculated popup positioning values", c),
                      r
                        .css(c)
                        ...
                        .addClass(S.loading),
                      (u = x.get.popupOffset()),
                      (d = x.get.distanceFromBoundary(u, t)),
                      x.is.offstage(d, e))
                    ) {
                      if (
                        (x.debug("Position is outside viewport", e),
                        j < C.maxSearchDepth)
                      )
                        return (
                          j++,
                          (e = x.get.nextPosition(e)),
                          x.debug("Trying new position", e),
                          !!r && x.set.position(e, t)
                        );
                      if (!C.lastResort)
                        return (
                          x.debug(
                          ...
                          x.error(k.cannotPlace, M),
                          x.remove.attempts(),
                          x.remove.loading(),
                          x.reset(),
                          C.onUnplaceable.call(r, M),
                          !1
                        );
                      x.debug("No position found, showing with last position");
                    }
                    return (
                      x.debug("Position is on stage", e),
                      x.remove.attempts(),
                      x.remove.loading(),
                      C.setFluidWidth && x.is.fluid() && x.set.fluidWidth(t),
                      !0
                    );
                  }
                  x.error(k.notFound);
                ...
                variation: function(e) {
                  (e = e || x.get.variation()) &&
                    x.has.popup() &&
                    (x.verbose("Adding variation to popup", e), r.addClass(e));
                },
                visible: function() {
              ...
              remove: {
                ...
                variation: function(e) {
                  (e = e || x.get.variation()) &&
                    (x.verbose("Removing variation", e), r.removeClass(e));
                },
                visible: function() {
                  E.removeClass(S.visible);
                },
                attempts: function() {
                  x.verbose("Resetting all searched positions"),
                    (j = 0),
                    (z = !1);
                }
              },
              bind: {
                events: function() {
                  x.debug("Binding popup events to module"),
                    "click" == C.on && E.on("click" + R, x.toggle),
                    "hover" == C.on &&
                      E.on("touchstart" + R, x.event.touchstart),
                    x.get.startEvent() &&
                      E.on(x.get.startEvent() + R, x.event.start).on(
                        x.get.endEvent() + R,
                        x.event.end
                      ),
                    C.target && x.debug("Target set to element", q),
                    l.on("resize" + b, x.event.resize);
                },
                popup: function() {
                  x.verbose(
                    ...
                    r &&
                      x.has.popup() &&
                      r
                        .on("mouseenter" + R, x.event.start)
                        .on("mouseleave" + R, x.event.end);
                },
                close: function() {
                  (!0 === C.hideOnScroll ||
                    ("auto" == C.hideOnScroll && "click" != C.on)) &&
                    x.bind.closeOnScroll(),
                    "hover" == C.on && I && x.bind.touchClose(),
                    "click" == C.on && C.closable && x.bind.clickaway();
                },
                closeOnScroll: function() {
                  x.verbose("Binding scroll close event to document"),
                    O.one(x.get.scrollEvent() + b, x.event.hideGracefully);
                },
                touchClose: function() {
                  x.verbose("Binding popup touchclose event to document"),
                    s.on("touchstart" + b, function(e) {
                      x.verbose("Touched away from popup"),
                        x.event.hideGracefully.call(M, e);
                    });
                },
                clickaway: function() {
                  x.verbose("Binding popup close event to document"),
                    s.on("click" + b, function(e) {
                      x.verbose("Clicked away from popup"),
                        x.event.hideGracefully.call(M, e);
                    });
                }
              },
              ...
              should: {
                centerArrow: function(e) {
                  return (
                    !x.is.basic() && e.target.width <= 2 * C.arrowPixelsFromEdge
                  );
                }
              },
              is: {
              ...
              g
                ? (L === i && x.initialize(), x.invoke(m))
                : (L !== i && L.invoke("destroy"), x.initialize());
          }),
          a !== i ? a : this
        );
      }),
    ...
    (e.fn.progress = function(t) {
      ...
      return (
        a.each(function() {
          ...
          (a = {
            initialize: function() {
              a.debug("Initializing progress bar", f),
                a.set.duration(),
                a.set.transitionEvent(),
                a.read.metadata(),
                a.read.settings(),
                a.instantiate();
            },
            instantiate: function() {
              a.verbose("Storing instance of progress", a),
                (T = a),
                x.data(y, a);
            },
            destroy: function() {
              a.verbose("Destroying previous progress for", x),
            ...
            complete: function() {
              (a.percent === i || a.percent < 100) &&
                (a.remove.progressPoll(), a.set.percent(100));
            },
            read: {
              metadata: function() {
                var e = {
                ...
                e.percent &&
                  ...
                  a.set.percent(e.percent)),
                  e.total &&
                    (a.debug("Total value set from metadata", e.total),
                    a.set.total(e.total)),
                  e.value &&
                    (a.debug("Current value set from metadata", e.value),
                    a.set.value(e.value),
                    a.set.progress(e.value));
              },
              settings: function() {
                !1 !== f.total &&
                  (a.debug("Current total set in settings", f.total),
                  a.set.total(f.total)),
                  !1 !== f.value &&
                    (a.debug("Current value set in settings", f.value),
                    a.set.value(f.value),
                    a.set.progress(a.value)),
                  !1 !== f.percent &&
                    (a.debug("Current percent set in settings", f.percent),
                    a.set.percent(f.percent));
              }
            },
            bind: {
            ...
            increment: function(e) {
              var t, n;
              a.has.total()
                ? (n = (t = a.get.value()) + (e = e || 1))
                : ((n = (t = a.get.percent()) + (e = e || a.get.randomValue())),
                  100,
                  a.debug("Incrementing percentage by", t, n)),
                (n = a.get.normalizedValue(n)),
                a.set.progress(n);
            },
            decrement: function(e) {
              ...
              a.get.total()
                ? ((n = (t = a.get.value()) - (e = e || 1)),
                  a.debug("Decrementing value by", e, t))
                : ((n = (t = a.get.percent()) - (e = e || a.get.randomValue())),
                  a.debug("Decrementing percentage by", e, t)),
                (n = a.get.normalizedValue(n)),
                a.set.progress(n);
            },
            has: {
            ...
            get: {
              text: function(e) {
                ...
                return (
                  (e = (e = e || "")
                    ...
                    .replace("{left}", o)
                    .replace("{percent}", i)),
                  a.verbose("Adding variables to progress bar text", e),
                  e
                );
              },
              normalizedValue: function(e) {
                ...
                if (a.has.total()) {
                  if (e > a.total)
                    return (
                      a.debug("Value cannot increment above total", a.total),
                      a.total
                    );
                } else if (e > 100)
                  return (
                    a.debug("Value cannot increment above 100 percent"), 100
                  );
                return e;
              },
              ...
              randomValue: function() {
                return (
                  a.debug("Generating random increment percentage"),
              ...
              displayPercent: function() {
                var e = C.width(),
                  t = x.width(),
                  n =
                    e > parseInt(C.css("min-width"), 10)
                      ? (e / t) * 100
                      : a.percent;
                return f.precision > 0
                  ? Math.round(n * (10 * f.precision)) / (10 * f.precision)
                  : Math.round(n);
              },
              percent: function() {
                return a.percent || 0;
            ...
            remove: {
              progressPoll: function() {
                a.verbose("Removing progress poll timer"),
                  a.progressPoll &&
                    (clearTimeout(a.progressPoll), delete a.progressPoll);
              },
              nextValue: function() {
                a.verbose("Removing progress value stored for next update"),
                  delete a.nextValue;
              },
              state: function() {
                a.verbose("Removing stored state"),
                  delete a.total,
                  delete a.percent,
                  delete a.value;
              },
            ...
            set: {
              barWidth: function(e) {
                e > 100
                  ...
                  : e < 0
                    ? a.error(v.tooLow, e)
                    : (C.css("width", e + "%"),
                      x.attr("data-percent", parseInt(e, 10)));
              },
              duration: function(e) {
                (e = "number" == typeof (e = e || f.duration) ? e + "ms" : e),
                  a.verbose("Setting progress bar transition duration", e),
              ...
              percent: function(e) {
                (e = "string" == typeof e ? +e.replace("%", "") : e),
                  (e =
                    f.precision > 0
                      ? Math.round(e * (10 * f.precision)) / (10 * f.precision)
                      : Math.round(e)),
                  (a.percent = e),
                  a.has.total() ||
                    ((a.value =
                      f.precision > 0
                        ? Math.round((e / 100) * a.total * (10 * f.precision)) /
                          (10 * f.precision)
                        : Math.round((e / 100) * a.total * 10) / 10),
                    f.limitValues &&
                      (a.value =
                        a.value > 100 ? 100 : a.value < 0 ? 0 : a.value)),
                  a.set.barWidth(e),
                  a.set.labelInterval(),
                  a.set.labels(),
                  f.onChange.call(k, e, a.value, a.total);
              },
              labelInterval: function() {
                clearInterval(a.interval),
                  a.bind.transitionEnd(function() {
                    a.verbose(
                  ...
                  (a.interval = setInterval(function() {
                    e.contains(n.documentElement, k) ||
                      (clearInterval(a.interval), (A = !1)),
                      a.set.labels();
                  }, f.framerate));
              },
              labels: function() {
                a.verbose("Setting both bar progress and outer label text"),
                  a.set.barLabel(),
                  a.set.state();
              },
              label: function(e) {
                (e = e || "") &&
                  ((e = a.get.text(e)),
                  a.verbose("Setting label to text", e),
                  S.text(e));
              },
              state: function(e) {
                100 === (e = e !== i ? e : a.percent)
                  ? f.autoSuccess &&
                    !(a.is.warning() || a.is.error() || a.is.success())
                    ? (a.set.success(),
                      a.debug("Automatically triggering success at 100%"))
                    : (a.verbose("Reached 100% removing active state"),
                      a.remove.active(),
                      a.remove.progressPoll())
                  : e > 0
                    ? (a.verbose("Adjusting active progress bar label", e),
                      a.set.active())
                    : (a.remove.active(), a.set.label(f.text.active));
              },
              barLabel: function(e) {
                e !== i
                  ? w.text(a.get.text(e))
                  : "ratio" == f.label && a.total
                    ? (a.verbose("Adding ratio to bar label"),
                      w.text(a.get.text(f.text.ratio)))
                    : "percent" == f.label &&
                      (a.verbose("Adding percentage to bar label"),
                      w.text(a.get.text(f.text.percent)));
              },
              active: function(e) {
                (e = e || f.text.active),
                  a.debug("Setting active state"),
                  f.showActivity && !a.is.active() && x.addClass(m.active),
                  a.remove.warning(),
                  a.remove.error(),
                  a.remove.success(),
                  (e = f.onLabelUpdate("active", e, a.value, a.total)) &&
                    a.set.label(e),
                  a.bind.transitionEnd(function() {
              ...
              success: function(e) {
                (e = e || f.text.success || f.text.active),
                  a.debug("Setting success state"),
                  x.addClass(m.success),
                  a.remove.active(),
                  a.remove.warning(),
                  a.remove.error(),
                  a.complete(),
                  f.text.success
                    ? ((e = f.onLabelUpdate("success", e, a.value, a.total)),
                      a.set.label(e))
                    : ((e = f.onLabelUpdate("active", e, a.value, a.total)),
                      a.set.label(e)),
                  a.bind.transitionEnd(function() {
              ...
              warning: function(e) {
                (e = e || f.text.warning),
                  a.debug("Setting warning state"),
                  x.addClass(m.warning),
                  a.remove.active(),
                  a.remove.success(),
                  a.remove.error(),
                  a.complete(),
                  (e = f.onLabelUpdate("warning", e, a.value, a.total)) &&
                    a.set.label(e),
                  a.bind.transitionEnd(function() {
              ...
              error: function(e) {
                (e = e || f.text.error),
                  a.debug("Setting error state"),
                  x.addClass(m.error),
                  a.remove.active(),
                  a.remove.success(),
                  a.remove.warning(),
                  a.complete(),
                  (e = f.onLabelUpdate("error", e, a.value, a.total)) &&
                    a.set.label(e),
                  a.bind.transitionEnd(function() {
            ...
            update: {
              ...
              progress: function(e) {
                var t;
                !1 === (e = a.get.numericValue(e)) && a.error(v.nonNumeric, e),
                  (e = a.get.normalizedValue(e)),
                  a.has.total()
                    ? (a.set.value(e),
                      (t = (e / a.total) * 100),
                      a.debug("Calculating percent complete from total", t),
                      a.set.percent(t))
                    : ((t = e),
                      a.debug("Setting value to exact percentage value", t),
                      a.set.percent(t));
              }
            },
            setting: function(t, n) {
            ...
            u
              ? (T === i && a.initialize(), a.invoke(c))
              : (T !== i && T.invoke("destroy"), a.initialize());
        }),
        o !== i ? o : this
      );
    }),
              ...
              event: {
                ...
                click: function() {
                  var t = e(this),
                    n = f.get.rating(),
                    i = S.index(t) + 1;
                  ("auto" == m.clearable ? 1 === S.length : m.clearable) &&
                  n == i
                    ? f.clearRating()
                    : f.set.rating(i);
                }
              ...
              set: {
                rating: function(e) {
                  ...
                  w.removeClass(p.selected),
                    S.removeClass(p.selected).removeClass(p.active),
                    e > 0 &&
            ...
            (m = {
              ...
              bind: {
                events: function() {
                  m.verbose("Binding events to search"),
                    g.automatic &&
                      (k.on(m.get.inputEvent() + w, y.prompt, m.event.input),
                      T.attr("autocomplete", "off")),
                    k
                      .on("focus" + w, y.prompt, m.event.focus)
              ...
              event: {
                  ...
                  n.activeElement === this ||
                    ...
                    m.resultsClicked
                      ? (m.debug(
                        ...
                        k.one("click.close" + w, y.results, function(e) {
                          m.is.inMessage(e) || O
                            ? T.focus()
                            : ((O = !1),
                ...
                result: {
                  ...
                  click: function(n) {
                    ...
                    if (
                      e.isFunction(g.onSelect) &&
                      !1 === g.onSelect.call(E, u, c)
                    )
                      return (
                        m.debug(
              ...
              get: {
                settings: function() {
                  e.isPlainObject(o) &&
                    o.searchFullText &&
                    ((g.fullTextSearch = o.searchFullText),
                    m.error(g.error.oldSearchSyntax, E));
                },
                inputEvent: function() {
                  var e = T[0];
                  return e !== i && e.oninput !== i
                    ? "input"
              ...
              search: {
                local: function(e) {
                  ...
                  m.set.loading(),
                    m.save.results(n),
                    m.debug("Returned full local search results", n),
                    g.maxResults > 0 &&
                      (m.debug("Using specified max results", n),
                      (n = n.slice(0, g.maxResults))),
                    "category" == g.type && (n = m.create.categoryResults(n)),
                ...
                cache: function(e) {
                  ...
                  e
                    ? e &&
                      ...
                      delete t[e],
                      k.data(h.cache, t))
                    : (m.debug("Clearing cache", e), k.removeData(h.cache));
                }
              },
              read: {
                cache: function(e) {
              ...
              create: {
                ...
                id: function(e, t) {
                  ...
                  return (
                    t !== i
                      ? ((n = String.fromCharCode(97 + t) + o),
                        m.verbose("Creating category result id", n))
                      : ((n = o), m.verbose("Creating result id", n)),
                    n
                  );
                },
                results: function() {
              ...
              addResults: function(t) {
                if (
                  e.isFunction(g.onResultsAdd) &&
                  !1 === g.onResultsAdd.call(R, t)
                )
                  return (
              ...
              d
                ? (F === i && m.initialize(), m.invoke(u))
                : (F !== i && F.invoke("destroy"), m.initialize());
          }),
          a !== i ? a : this
        );
      }),
            ...
            (g = {
                ...
                g.verbose("Animating box with properties", e),
                  ...
                  g.get.transitionEvent()
                    ? (g.verbose("Starting CSS animation"),
                      ...
                      k.css(e).one(g.get.transitionEvent(), n),
              ...
              queue: function(e) {
                g.debug("Queueing animation of", e),
                  k.one(g.get.transitionEvent(), function() {
              ...
              set: {
                ...
                duration: function(e) {
                  (e = "number" == typeof (e = e || h.duration) ? e + "ms" : e),
                ...
                stageSize: function() {
                  ...
                  t.removeClass(x.active),
                    ...
                    e.remove(),
                    "auto" != h.width &&
                      (S.css("width", i + h.jitter),
                      g.verbose("Specifying width during animation", i)),
                    "auto" != h.height &&
                      (S.css("height", o + h.jitter),
              ...
              flip: {
                ...
                over: function() {
                  !g.is.complete() || g.is.animating() || h.allowRepeats
                    ? g.is.animating()
                      ? g.queue("flip over")
                    ...
                    : g.debug("Side already visible", m);
                },
                back: function() {
                  !g.is.complete() || g.is.animating() || h.allowRepeats
                    ? g.is.animating()
              ...
              u
                ? (P === i && g.initialize(), g.invoke(c))
                : (P !== i && P.invoke("destroy"), g.initialize());
          }),
          a !== i ? a : this
        );
      }),
            ...
            (w = {
              initialize: function() {
                w.debug("Initializing sidebar", o),
                  ...
                  S.delaySetup ? v(w.setup.layout) : w.setup.layout(),
                  v(function() {
                    w.setup.cache();
                  }),
                  w.instantiate();
              ...
              setup: {
                ...
                layout: function() {
                  0 === D.children(k.pusher).length &&
                    (w.debug("Adding wrapper element for sidebar"),
                    w.error(P.pusher),
                    (j = e('<div class="pusher" />')),
                    D.children()
                      .not(k.omitted)
                      .not(q)
                      .wrapAll(j),
                    w.refresh()),
                    (0 !== O.nextAll(k.pusher).length &&
                      O.nextAll(k.pusher)[0] === j[0]) ||
                      (w.debug("Moved sidebar to correct parent element"),
                      w.error(P.movedSidebar, z),
              ...
              show: function(t) {
                if (
                  ...
                  if (
                    (w.refreshSidebars(),
                    S.overlay &&
                      (w.error(P.overlay), (S.transition = "overlay")),
                    w.refresh(),
                    w.othersActive())
                  )
                    if (
                      (w.debug("Other sidebars currently visible"), S.exclusive)
                    ) {
                      if ("overlay" != S.transition)
              ...
              pushPage: function(t) {
                ...
                (t = e.isFunction(t) ? t : function() {}),
                  "scale down" == S.transition && w.scrollToTop(),
                  w.set.transition(a),
                  w.repaint(),
                  (n = function() {
                    w.bind.clickaway(),
              ...
              get: {
                ...
                transition: function() {
                  ...
                  return (
                    (e = w.is.mobile()
                      ? "auto" == S.mobileTransition
                        ? S.defaultTransition.mobile[t]
                        : S.mobileTransition
                      : "auto" == S.transition
                        ? S.defaultTransition.computer[t]
                        : S.transition),
            ...
            (h = {
              ...
              destroy: function() {
                h.verbose("Destroying previous instance"),
                  ...
                  p && p.disconnect(),
                  k
                    .off("load" + C, h.event.load)
                    .off("resize" + C, h.event.resize),
              ...
              observeChanges: function() {
                "MutationObserver" in t &&
                  ...
                  p.observe(P, { childList: !0, subtree: !0 }),
              ...
              determineContext: function() {
                0 !== (m = v.context ? e(v.context) : r).length ||
                  h.error(x.invalidContext, v.context, S);
              },
              checkErrors: function() {
                if (
                  (h.is.hidden() && h.error(x.visible, S),
                  h.cache.element.height > h.cache.context.height)
                )
                  return h.reset(), void h.error(x.elementSize, S);
              },
              bind: {
                events: function() {
                  k
                    .on("load" + C, h.event.load)
                    .on("resize" + C, h.event.resize),
                    T.off("scroll" + C)
              ...
              get: {
                ...
                currentElementScroll: function() {
                  return h.elementScroll
                    ? h.elementScroll
                    : h.is.top()
                      ? Math.abs(parseInt(S.css("top"), 10)) || 0
                      : Math.abs(parseInt(S.css("bottom"), 10)) || 0;
                },
                elementScroll: function(e) {
                  e = e || T.scrollTop();
              ...
              set: {
                ...
                scroll: function(e) {
                  h.debug("Setting scroll on element", e),
                    h.elementScroll != e &&
                      (h.is.top() && S.css("bottom", "").css("top", -e),
                      h.is.bottom() && S.css("top", "").css("bottom", e));
                },
                size: function() {
          ...
          r.each(function() {
            ...
            (b = {
              ...
              changeTab: function(n) {
                var i =
                    t.history && t.history.pushState && x.ignoreFirstLoad && E,
                ...
                (n = b.utilities.arrayToPath(a)),
                  e.each(a, function(t, r) {
                    ...
                    if ((b.verbose("Looking for tab", r), m)) {
                        ...
                        return (
                          i
                            ? (b.debug(
                              ...
                              b.activate.all(f),
                              x.onFirstLoad.call(S[0], f, v, y),
                              x.onLoad.call(S[0], f, v, y))
                      ...
                      if (-1 != n.search("/") || "" === n)
                        return b.error(k.missingTab, R, g, f), !1;
                      if (
                        ((f = (s = e("#" + n + ', a[name="' + n + '"]'))
                          .closest("[data-tab]")
                          .data(w.tab)),
                        ...
                        return (
                          b.debug("Anchor link used, opening parent tab", S, s),
                          S.hasClass(C.active) ||
                            setTimeout(function() {
                              b.scrollTo(s);
                            }, 0),
                ...
                defaultPath: function(e) {
                  var t =
                    r
                      ...
                      .data(w.tab) || !1;
                  if (t) {
                    if ((b.debug("Found default tab", t), F < x.maxDepth))
                      return F++, b.get.defaultPath(t);
                    b.error(k.recursion);
          ...
          a.each(function(t) {
            ...
            (C = {
              ...
              delay: function(e) {
                ...
                o || (o = C.can.transition() ? C.get.direction() : "static"),
                  (e = e !== i ? e : m.interval),
                  (n =
                    ("auto" == m.reverse && o == h.outward) || 1 == m.reverse
              ...
              animate: function(e) {
                ...
                C.can.animate()
                  ...
                  : C.error(p.noAnimation, m.animation, S);
              },
              reset: function() {
          ...
          (h = {
            ...
            write: {
              cachedResponse: function(n, o) {
                o && "" === o
                  ? h.debug("Response empty, not caching", o)
                  : t.Storage !== i
                    ? (e.isPlainObject(o) && (o = JSON.stringify(o)),
                      sessionStorage.setItem(n, o),
                      h.verbose("Storing cached response for url", n, o))
                    : h.error(C.noStorage);
              }
            },
            query: function() {
              if (h.is.disabled())
                ...
                if (
                  ...
                  return (h.cancelled = !0), void h.error(C.beforeSend);
                if (
                  ((h.cancelled = !1),
                  (m = h.get.templatedURL()) || h.is.mocked())
                ) {
                    ...
                    v.throttle
                      ? v.throttleFirstRequest || h.timer
                        ...
                        : (h.debug("Sending request", g, a.method),
                          h.send.request(),
                          (h.timer = setTimeout(function() {}, v.throttle)))
                      : (h.debug("Sending request", g, a.method),
                        h.send.request());
                  }
            ...
            should: {
              removeError: function() {
                return (
                  !0 === v.hideError || ("auto" === v.hideError && !h.is.form())
                );
              }
            },
            is: {
                  ...
                  e.isPlainObject(t)
                    ? n
                      ...
                      : (h.error(C.missingSerialize),
                        ...
                        (t = o))
                    : (h.debug("Adding form data", o), (t = o)),
                  t
                );
              }
            },
            ...
            create: {
              ...
              mockedXHR: function() {
                ...
                return (
                  ...
                  o
                    ? (e.isFunction(o)
                        ? (h.debug("Using specified synchronous callback", o),
                          (n = o.call(E, f)))
                      ...
                      ((t = function(e) {
                        h.debug("Async callback returned response", e),
                          e
                            ...
                            : i.rejectWith(E, [{ responseText: e }, !1, !1]);
                      }),
                      h.debug("Using specified async response callback", a),
                      a.call(E, f, t)),
                  i
                );
              },
            ...
            (v = {
              ...
              destroy: function() {
                v.verbose("Destroying previous module"),
                  h && h.disconnect(),
                  p && p.disconnect(),
                  T.off("load" + S, v.event.load).off(
                    "resize" + S,
                    v.event.resize
                  ),
                  R.off("scroll" + S, v.event.scroll).off(
                    "scrollchange" + S,
                    v.event.scrollchange
                  ),
                  "fixed" == b.type && (v.resetFixed(), v.remove.placeholder()),
                  A.off(S).removeData(k);
              },
              observeChanges: function() {
                "MutationObserver" in t &&
              ...
              bind: {
                events: function() {
                  v.verbose("Binding visibility events to scroll and resize"),
                    b.refreshOnLoad && T.on("load" + S, v.event.load),
                    T.on("resize" + S, v.event.resize),
                    R.off("scroll" + S)
                      .on("scroll" + S, v.event.scroll)
                      .on("scrollchange" + S, v.event.scrollchange);
                }
              },
              event: {
                changed: function(e) {
                ...
                elementPosition: function() {
                  ...
                  return (
                    ...
                    v.is.verticallyScrollableContext() &&
                      (e.offset.top += R.scrollTop() - R.offset().top),
                    v.is.horizontallyScrollableContext() &&
                      (e.offset.left += R.scrollLeft - R.offset().left),
                    (v.cache.element = e),
                    e
                  );
                },
              ...
              d
                ? (P === i && v.initialize(),
                  ...
                  P.save.calculations(),
                  v.invoke(u))
                : (P !== i && P.invoke("destroy"), v.initialize());
          }),
          a !== i ? a : this
        );
      }),
